...
type TranslationProvider interface {
	Translate(context.Context, models.Translation) (models.Translation, error)
	History(context.Context) ([]models.Translation, error)
}
...
func newTranslationRoutes(handler *gin.RouterGroup, t TranslationProvider, l logger.Interface) {
...
type historyResponse struct {
	History []models.Translation `json:"history"`
}
